...
\scalebox{0.35}{
  ...
  \node[font=\fontsize{26}{12}\selectfont, align=right, outer sep=0.5mm, anchor = west, text width=7cm] at (-8cm,21.0cm) {Types of display information:};
    ...
    \node[font=\fontsize{26}{12}\selectfont, align=left, outer sep=0.5mm, anchor = west, text width=28cm] at (24cm,0cm) {Longer texts are scrolled through the display, e.g. parameter names, message, etc.};
    ...
    \node[font=\fontsize{26}{12}\selectfont, align=left, outer sep=0.5mm, anchor = west, text width=28cm] at (24cm,-10cm) {Status in SysEx firmware update mode, e.g. ready for upload, success, error.};
  \end{tikzpicture}
}
