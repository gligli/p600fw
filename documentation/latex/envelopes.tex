...
\scalebox{0.4}{
  \begin{tikzpicture}[scale=0.8]
    ...
    \addpar{-18cm,3.5cm}{\secndenv \\ This modifies the shape and speed of the second envelope, e.g. it influences the attack, decay and release phases of the envelope};
