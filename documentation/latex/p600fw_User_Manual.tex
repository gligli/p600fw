...
\scalebox{0.22}{
  ...
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 70cm, minimum height = 3cm, anchor = south west] (r) at (0cm,22.25cm) {}; % rear
 
  \prophetdisplay{4cm,17.5cm}{123}{12754}{1}
  \numberpad{1cm,4cm}
  \node[font=\fontsize{18}{12}\selectfont, text width=8cm, text centered, inner sep=0.0mm, minimum width=8cm] at (5cm,3cm) {PROGRAM SELECT};
  \draw[line width=2pt]++(10,20)--++(0,-18cm); % -0.9cm,-4.65cm  
  \buttonblock{11cm,7cm}{P}{}
  \prophetpot{16.9cm,4.5cm}{SPEED}{75}
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 19cm, minimum height = 16cm, anchor = south west] (r) at (0cm,1cm) {}; % buttons
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 50cm, minimum height = 16cm, anchor = south west] (r) at (25cm,1cm) {}; % panel
  
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 9cm, minimum height = 6.5cm, anchor = south west] (r) at (26.25cm,11.5cm) {\Large\textit{Poly-Mod Subpanel}};
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 14cm, minimum height = 6.5cm, anchor = south west] (r) at (26.25cm,2cm) {\Large\textit{LFO Subpanel}};
  
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 14cm, minimum height = 6.5cm, anchor = south west] (r) at (45cm,11.5cm) {\Large\textit{OSC A Subpanel}};
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 14cm, minimum height = 6.5cm, anchor = south west] (r) at (45cm,2cm) {\Large\textit{OSC B Subpanel}};

  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 14cm, minimum height = 8.5cm, anchor = south west] (r) at (63.75cm,9cm) {\Large\textit{Filter Subpanel}};
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 14cm, minimum height = 4.5cm, anchor = south west] (r) at (63.75cm,2cm) {\Large\textit{(Amp) Envelope Subpanel}};

  \prophetpot{84.5cm,16.5cm}{MASTER TUNE}{75}
  \prophetpot{84.5cm,7.5cm}{VOLUME}{75}
  ...
  \node[rectangle, draw, rounded corners=7pt, line width=1pt, minimum width = 62cm, minimum height = 8cm, anchor = north west] (r) at (10cm,-0.25cm) {\Large\textit{Keyboard}};
  ...
  \node[font=\fontsize{26}{12}\selectfont, align=right, outer sep=0.5mm, anchor = east] at (-2cm,23.75cm) (pd) {Rear};
  \draw[line width=1pt]++(pd.east)--++(2.5cm,0cm);  
  
  \node[font=\fontsize{26}{12}\selectfont, align=left, outer sep=0.5mm, anchor = west] at (89.5cm,19cm) (pl) {Panel};
  \draw[line width=1pt]++(pl.west)--++(-2.5cm,0cm);  

  \node[font=\fontsize{26}{12}\selectfont, align=left, outer sep=0.5mm, anchor = west] at (89.5cm,-3.5cm) (kb) {Keyboard};
