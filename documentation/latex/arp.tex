The upgraded Prophet 600 supports three arpeggiator modes which are activated using the arpeggiator buttons as described in the following.
...
Note that compared the version 2.0 and 2.1 RC3 the up/down pattern and the random pattern have been changed. In former versions the lowest and highest note in the up/down pattern were played twice (e.g. "1234432112...", in version \version they are only played once "12343212...". Formerly, a single note could be repeated two or more times in the random pattern. In version \version a note is never repeated (unless there is only one note to play).
